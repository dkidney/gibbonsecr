...
You only need to run the above steps once. When everything is installed you can launch the user interface by opening R (or RStudio) and typing the following lines into the console.
...
<a href="#data-buttons">**4.3 The Import button**</a>
...
<a href="#mask-buttons">**5.3 The Make button**</a>  
...
* **`D`** -- The number of groups per square kilometer
...
* **`pcall`** -- The probablity of a group calling on a given day
